...
const buildConfig = async () => {
  ...
  await Promise.all([
    ...
    writeFile(
      ...
      sassComment + os.EOL + '@use "uswds" as *;' + os.EOL + renderUswdsConfig(transformed.data)
    ),
    writeFile(
      path.join(scssDir, '_design-tokens.artifact.scss'),
      sassComment + os.EOL + '@use "uswds" as *;' + os.EOL + '@use "../uswds-theme-settings.artifact" as *;' + os.EOL + renderSass(transformed.data)
    ),
  ]);
};
