...
class EPABulkRepublishAction extends ViewsBulkOperationsActionBase implements ContainerFactoryPluginInterface
{
  ...
  public function execute($entity = NULL)
  {
    ...
    return $this->t('The selected content with current revisions matching any of these states: "Published needs review", Published scheduled for expiration", and "Published, one day until expiration" were republished and state set to "Published".');
  }
