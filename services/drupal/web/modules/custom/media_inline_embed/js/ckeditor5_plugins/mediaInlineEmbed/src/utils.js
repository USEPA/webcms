 ...
 * @private
 */
export function isDrupalInlineMedia(modelElement) {
 ...
 * @private
 */
export function isDrupalInlineMediaWidget(viewElement) {
  return (
    isWidget(viewElement) && !!viewElement.getCustomProperty('drupalInlineMedia')
  );
}
 ...
 * @private
 */
export function getClosestSelectedDrupalInlineMediaElement(selection) {
 ...
 * @private
 */
export function getClosestSelectedDrupalInlineMediaWidget(selection) {
