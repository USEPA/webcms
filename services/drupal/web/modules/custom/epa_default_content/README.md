...
3. Export content using `drush dcer`, which exports the content and any referenced entity (e.g. a node with a file field, both the node and the file entity with be exported).
