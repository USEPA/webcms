...
/**
 * Class DanseModerationNotificationsAddForm.
 *
 * Provides the add form for our DanseModerationNotifications entity.
 *
 * @package Drupal\danse_moderation_notifications\Form
 *
 * @ingroup danse_moderation_notifications
 */
class DanseModerationNotificationsAddForm extends DanseModerationNotificationsFormBase {
