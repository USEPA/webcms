...
class ProblemWebforms extends ControllerBase {
  ...
  public function list() {
    ...
    $ids = $db->query("SELECT SUBSTRING(name, 17) FROM config WHERE name LIKE 'webform.webform.%' AND data LIKE '%s:7:\"subject\";s:7:\"default\"%'", [], ['allow_delimiter_in_query' => TRUE])->fetchCol();
