...
$creds = json_decode(getenv('WEBCMS_DB_CREDS'), JSON_THROW_ON_ERROR);
...
$creds = json_decode(getenv('WEBCMS_DB_CREDS_D7'), JSON_THROW_ON_ERROR);
...
$config['migrate_plus.migration_group.migrate_drupal_7']['shared_configuration']['source']['database']['username'] = $creds['username'];
$config['migrate_plus.migration_group.migrate_drupal_7']['shared_configuration']['source']['database']['password'] = $creds['password'];
