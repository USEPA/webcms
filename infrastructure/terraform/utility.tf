    ...
    write_files:
      - path: /usr/local/bin/webcms-env-info
        ...
        content: |
          ...
          D8 user: webcms
          D8 name: webcms
          D8 credentials: https://console.aws.amazon.com/secretsmanager/home?region=${data.aws_region.current.name}#/secret?name=${urlencode(aws_secretsmanager_secret.db_app_credentials.name)}

          D7 user: webcms_d7
          D7 name: webcms_d7
          D7 credentials: https://console.aws.amazon.com/secretsmanager/home?region=${data.aws_region.current.name}#/secret?name=${urlencode(aws_secretsmanager_secret.db_app_d7_credentials.name)}
