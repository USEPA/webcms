...
#  name        = "${var.iam_prefix}-${var.aws_region}-${var.environment}-Proxy"
...
#  name        = "${var.iam_prefix}-${var.aws_region}-${var.environment}-ProxySecretsAccess"
...
#
#  db_cluster_identifier = "${var.proxy_target_endpoint}"
#}
