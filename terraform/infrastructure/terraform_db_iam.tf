...
resource "aws_iam_role" "terraform_database_exec" {
  name        = "${var.iam_prefix}-${var.aws_region}-${var.environment}-TerraformDatabaseExecution"
...
resource "aws_iam_policy" "terraform_database_credentials_access" {
  name        = "${var.iam_prefix}-${var.aws_region}-${var.environment}-TerraformDatabaseRootCredsAccess"
...
resource "aws_iam_role" "terraform_database_task" {
  name        = "${var.iam_prefix}-${var.aws_region}-${var.environment}-TerraformDatabaseTask"
...
resource "aws_iam_policy" "terraform_database_tfstate_access" {
  name        = "${var.iam_prefix}-${var.aws_region}-${var.environment}-TerraformDatabaseTFStateAccess"
...
resource "aws_iam_policy" "terraform_database_secrets_access" {
  name        = "${var.iam_prefix}-${var.aws_region}-${var.environment}-TerraformDatabaseSecretsAccess"
