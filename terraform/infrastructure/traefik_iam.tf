resource "aws_iam_role" "traefik_task" {
  name        = "${var.iam_prefix}-${var.aws_region}-${var.environment}-TraefikTask"
...
resource "aws_iam_policy" "traefik_ecs_access" {
  name        = "${var.iam_prefix}-${var.aws_region}-${var.environment}-TraefikECSAccess"
...
resource "aws_iam_role" "traefik_exec" {
  name        = "${var.iam_prefix}-${var.aws_region}-${var.environment}-TraefikExecution"
